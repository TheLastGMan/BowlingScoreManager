...
<Assembly: PreApplicationStartMethod(GetType(PluginManager), "Initialize")> 
Public Class PluginManager

    Private Shared ReadOnly Locker As ReaderWriterLockSlim = New ReaderWriterLockSlim()
    ...
    Public Shared Sub Initialize()
        ...
        Using New WriteLockDisposable(Locker)
            ...
            For Each file In New IO.DirectoryInfo(HostingEnvironment.MapPath(_pluginsPathInstalled)).GetFiles("*.dll", IO.SearchOption.AllDirectories)
                LoadAssebmly(file)
            Next
